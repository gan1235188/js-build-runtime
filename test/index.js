 ...
 *  1，do表达式的优势是什么
 *  2，json-string是啥
 *  3，@babel/plugin-proposal-decorators的legacy是什么作用
 */
...
const plugins = [
    ...
    '@babel/plugin-transform-property-literals', //es3
    ...
    '@babel/plugin-transform-reserved-words', //es3
...
//babel插件列表:https://www.babeljs.cn/docs/plugins
const transformConfig = {
    //TODO:不懂！！！ 好像是转化字符串的
    jsonStrings: '@babel/plugin-proposal-json-strings', //忽略
...
const ast = transform(fs.readFileSync('./test/test.js'), {
    ast: true,
    code: true,
    envName: 'production',
...
const output = path.resolve(__dirname, '../dist/output.js')
fs.writeFileSync(output, ast.code)